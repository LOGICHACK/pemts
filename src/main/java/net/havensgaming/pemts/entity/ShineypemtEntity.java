...
public class ShineypemtEntity extends TamableAnimal {
	public ShineypemtEntity(EntityType<ShineypemtEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		ShineypemtEntity retval = PemtsModEntities.SHINEYPEMT.create(serverWorld);
	...
	public static void init() {
		BiomeModifications.create(new ResourceLocation(PemtsMod.MODID, "shineypemt_entity_spawn")).add(ModificationPhase.ADDITIONS, BiomeSelectors.includeByKey(ResourceKey.create(Registries.BIOME, new ResourceLocation("dripstone_caves")),
				...
				ctx -> ctx.getSpawnSettings().addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(PemtsModEntities.SHINEYPEMT, 10, 1, 1)));
	}
